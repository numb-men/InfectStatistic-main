...
class CmdArgsTest {
    ...
    public static String[] args1 = new String[] {"list",
            ...
            "-out", "/home/yyx/JavaWorkspace/InfectStatistic-main/221701232/result/output1.txt",
            "-date", "2020-01-22"};
    /**
     * command line :
    ...
    public static String[] args2 = new String[] {"list",
            "-log", "/home/yyx/JavaWorkspace/InfectStatistic-main/221701232/log",
            "-out", "/home/yyx/JavaWorkspace/InfectStatistic-main/221701232/result/output2.txt",
            "-date", "2020-01-22",
            "-province", "福建", "河北"};
    /**
     * command line :
    ...
    public  static String[] args3 = new String[] {"list",
            "-log", "/home/yyx/JavaWorkspace/InfectStatistic-main/221701232/log",
            "-out", "/home/yyx/JavaWorkspace/InfectStatistic-main/221701232/result/output3.txt",
            "-date", "2020-01-23",
            "-type", "cure", "dead", "ip",
            "-province", "全国", "浙江" ,"福建"};
